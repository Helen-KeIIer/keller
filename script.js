...
/* PERIODS - UPRAVENO: Zarovnání vlevo a žádný margin auto */
.periods-section{
  background: transparent;
  padding-top: 36px;
  padding-bottom: 0;
...
.period__year{
  width: 100%;
  max-width: var(--theory-max);
  /* UPRAVENO: Margin 0 zarovná vlevo k paddingu stránky */
  margin: 0;
  font-family:"NeueHaasLight", sans-serif;
  font-weight:300;
  font-size: var(--hl-size);
